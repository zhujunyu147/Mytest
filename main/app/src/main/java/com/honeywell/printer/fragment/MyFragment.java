...
import com.honeywell.printer.activity.BaseActivity;
import com.honeywell.printer.application.Constant;
import com.honeywell.printer.tabhost.FragmentInterface;
...
public abstract class MyFragment extends Fragment implements FragmentInterface {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && isSaveState()) {
            isOnInit = savedInstanceState.getBoolean(com.honeywell.printer.application.Constant.KEY_TAB_INIT);
        }
