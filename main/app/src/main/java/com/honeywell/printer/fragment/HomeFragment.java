...
import com.honeywell.printer.adapter.PersonalLetterTabFragmentAdapter;
import com.honeywell.printer.application.SoftApplication;
import com.honeywell.printer.indicator.TabPageIndicator;
...
public class HomeFragment extends MyFragment  implements View.OnClickListener {
    ...
    * */
    ...
    private MyPrinterDeviceFragment mMyPrinterDeviceFragment;
    private VeidioFragment mSpecialFragment;
...
//        setListener();//控件监听事件处理
    ...
    private void initView() {
        ...
        mMyPrinterDeviceFragment = new MyPrinterDeviceFragment();
        mSpecialFragment = new VeidioFragment();
        mArticleFragment = new ArticleFragment();

        fragmentsList.add(mMyPrinterDeviceFragment);
        fragmentsList.add(mSpecialFragment);
        fragmentsList.add(mArticleFragment);
    ...
    public MyPrinterDeviceFragment getmMyPrinterDeviceFragment(){
        return mMyPrinterDeviceFragment;
    }
