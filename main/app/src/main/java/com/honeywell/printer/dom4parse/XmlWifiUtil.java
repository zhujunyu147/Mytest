 ...
 */
public class XmlWifiUtil {

    public static void startConnect(final Context context, final CommondWifiEvent.CommondExcuter excuter) {
        String message = "{_CLC:HCD}" + "\n";
        ParseWifiXml parseXml = new ParseWifiXml(context, ParseXml.RequestType.REQUEST_CLC, message);
        parseXml.sendMessage(new ParseWifiXml.Response() {

            @Override
            public void success(Element element) {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.CLC_SUCCESS, excuter));
                String message = "<DevInfo Action=\"RQ_CONN\">\n" +
                        "</DevInfo>\n";
                ParseWifiXml parseXml = new ParseWifiXml(context, ParseXml.RequestType.REQUEST_CONN, message);
                parseXml.sendMessage(new ParseWifiXml.Response() {

                    @Override
                    public void success(Element element) {
                        CoreXmlParse.parseCnnXml(context, element);
                        EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.CNN_SUCCESS, excuter));
                    }

                    @Override
                    public void failed() {
                        EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.CNN_FAILED, excuter));
                    }
                });
            }
            ...
            @Override
            public void failed() {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.CLC_FAILED, excuter));
            }
        });
    }


    private static void endConnect(final Context context, final CommondWifiEvent.CommondExcuter excuter) {
        ...
        parseXml.sendMessage(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.END_SUCCESS, excuter));
            }

            @Override
            public void failed() {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.END_FAILED, excuter));
            }
        });
    }


    public static void getSystemInfoData(final Context context, final CommondWifiEvent.CommondExcuter excuter) {
        ...
        parseXml.sendMessage(new ParseWifiXml.Response() {
            ...
            public void success(Element element) {
                ...
                EventBus.getDefault().post(new PrinterWifiDateEvent(mBaseItemList, PrinterWifiDateEvent.PrinterDataType.SYSTEM_INFO));
    ...
    public static void searchConfig(final Context context, final CommondWifiEvent.CommondExcuter excuter) {
        String message = "<DevInfo Action=\"GetConfig\"><Group Name=\"Printer Settings\"><Group Name=\"Printing\"></Group></Group></DevInfo>\n";
        ParseWifiXml parseXml = new ParseWifiXml(context, ParseXml.RequestType.REQUEST_SYSTEMINFO, message);
        parseXml.sendMessageForSave(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
                List<BaseItem> mBaseItemList = CoreXmlParse.parseGetConfigXml(element);
                EventBus.getDefault().post(new PrinterWifiDateEvent(mBaseItemList, PrinterWifiDateEvent.PrinterDataType.GET_CONFIG));
                endConnect(context, excuter);
            }
    ...
    public static void setConfig(final Context context, BaseItem baseItem, final CommondWifiEvent.CommondExcuter excuter) {
        String message = "";
        ...
        parseXml.sendMessage(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.SET_CONFIG_SUCCESS, excuter));
                endConnect(context, excuter);
            }

            @Override
            public void failed() {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.SET_CONFIG_FAILED, excuter));
            }
        });
    }


    public static void restartCommond(final Context context, final CommondWifiEvent.CommondExcuter excuter) {
        String message = "<DevInfo Action=\"Restart\"></DevInfo>\n";
        ParseWifiXml parseXml = new ParseWifiXml(context, ParseXml.RequestType.REQUEST_SYSTEMINFO, message);
        parseXml.sendMessage(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.RESTART_SUCCESS, excuter));
                endConnect(context, excuter);
            }

            @Override
            public void failed() {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.RESTART_FAILED, excuter));
            }
        });
    }


    public static void uploadConfigCommond(final Context context, String fileName, final CommondWifiEvent.CommondExcuter excuter) {
        ...
        parseXml.sendMessage(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.UPLOAD_CONFIG_SUCCESS, excuter));
                endConnect(context, excuter);
            }

            @Override
            public void failed() {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.UPLOAD_CONFIG_FAILED, excuter));
            }
        });
    }


    public static void picPrinterCommond(final Context context, final CommondWifiEvent.CommondExcuter excuter, byte[] picContent) {
...
//        byte[] after = "\nPF 1\n".getBytes();
        ...
        ParseWifiXml parseXml = new ParseWifiXml(context, newByte);
        Log.e("############", "" + newByte.length);
        parseXml.sendPicMessage(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
...
//        });
    ...
    public static void printConfig(final Context context, final CommondWifiEvent.CommondExcuter excuter) {
        ...
        parseXml.sendMessage(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.PRINT_CONFIG_SUCCESS, excuter));
                endConnect(context, excuter);
            }

            @Override
            public void failed() {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.PRINT_CONFIG_FAILED, excuter));
            }
        });
    }
    ...
    public static void mediumCheck(final Context context, final CommondWifiEvent.CommondExcuter excuter) {
        ...
        parseXml.sendMessage(new ParseWifiXml.Response() {
            @Override
            public void success(Element element) {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.MEDIUM_CHECK_SUCCESS, excuter));
                endConnect(context, excuter);
            }

            @Override
            public void failed() {
                EventBus.getDefault().post(new CommondWifiEvent(CommondWifiEvent.CommondExcudeState.MEDIUM_CHECK_FAILED, excuter));
            }
        });
